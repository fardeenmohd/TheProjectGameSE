...
def getgames():
	...
	messagetemp = ET.tostring(root, encoding = 'unicode')
...
class Message:
	...
	def dataresponsefordiscover(self, playerid, gamefinished, taskfieldsX, taskfieldsY, taskfieldsdistances, pieceid,
	                            piecetype):
		"""
	...
	# MoveResponseGood
	def moveresponsegood(self, playerid, gamefinished, taskfieldsX, taskfieldsY, taskfieldsdistances, playerlocationx,
	                     playerlocationy):
		"""
	...
	# MoveResponsePlayer
	def moveresponseplayer(self, playerid, gamefinished, taskfieldsX, taskfieldsY, taskfieldsdistances, playerlocationx,
	...
	def knowledgeexchangeresponse(self, playerid, gamefinished, xtaskfield, ytaskfield, distancetopiece, xgoalfield,
	                              ygoalfield, team, fieldtype, goalfieldplayerid, pieceid, piecetype):
		"""
		...
		for i in range(0, numberoffields):
			myattributes = {'x': str(xtaskfield[i]), 'y': str(ytaskfield[i]),
			                'timestamp': str(strftime("%Y-%m-%dT%H:%M:%S", gmtime())),
		...
		for i in range(0, numberofgoals):
			myattributes = {'x': str(xgoalfield[i]), 'y': str(ygoalfield[i]),
		...
		for i in range(0, numberofpieces):
			myattributes = {'id': str(pieceid[i]), 'timestamp': str(strftime("%Y-%m-%dT%H:%M:%S", gmtime())),
